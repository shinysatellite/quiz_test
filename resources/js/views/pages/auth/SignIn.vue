  ...
  <base-background image="/img/photos/photo28@2x.jpg">
    <b-row no-gutters class="bg-primary-dark-op">
      ...
      >
        ...
        <div
          class="p-4 p-xl-5 d-xl-flex justify-content-between align-items-center font-size-sm"
        >
          ...
          <ul class="list list-inline mb-0 py-2">
            <li class="list-inline-item">
              <a class="text-white-75 font-w500" href="javascript:void(0)"
                >Legal</a
              >
            </li>
            <li class="list-inline-item">
                ...
                <b-form @submit.stop.prevent="onSubmit">
                  ...
                  >
                    <div>
                      <router-link
                        to="/auth/reminder3"
                        class="text-muted font-size-sm font-w500 d-block d-lg-inline-block mb-1"
                        >Forgot Password?</router-link
                      >
                    </div>
                    <div>
                      <button type="submit" class="btn btn-lg btn-alt-primary">
                        <i class="fa fa-fw fa-sign-in-alt mr-1 opacity-50"></i>
                        Sign In
                      </button>
                    </div>
                  </div>
