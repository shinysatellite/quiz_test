        ...
        <b-row class="py-5">
          <b-col lg="6" class="text-center text-lg-left d-flex align-items-center">
            <div class="w-100">
              ...
              <p class="font-size-lg font-w500 text-muted mb-4 mr-5">
                One super flexible UI framework for amazing developers and web agencies. Now rebuilt from scratch with Vue.js.
              </p>
              <a class="btn btn-primary text-uppercase font-size-sm px-3 py-2 mr-2 mt-2" href="https://1.envato.market/5Noyb" v-click-ripple>
              ...
              <router-link to="/backend/dashboard" custom v-slot="{ href, navigate }">
                <a class="btn btn-dark text-uppercase font-size-sm px-3 py-2 mr-2 mt-2" :href="href" @click="navigate" v-click-ripple target="_blank">
          ...
          <div class="py-5 text-center">
            ...
            <b-row no-gutters class="mx-lg-8">
              <b-col sm="4" class="p-3">
                <p class="font-size-h1 font-w700 text-white mb-0">
                  4,500+
                </p>
    ...
    <div class="bg-white">
      <div class="content content-full content-boxed">
        <div class="py-5 py-md-8 text-center">
          ...
          <a class="btn btn-primary text-uppercase font-size-sm px-3 py-2 m-1" href="https://1.envato.market/5Noyb" v-click-ripple>
            <i class="fa fa-fw fa-shopping-cart font-size-base opacity-50 mr-1"></i> Purchase
          </a>
          <router-link to="/backend/dashboard" custom v-slot="{ href, navigate }">
            <a class="btn btn-dark text-uppercase font-size-sm px-3 py-2 m-1" :href="href" @click="navigate" v-click-ripple target="_blank">
              <i class="fa fa-fw fa-rocket font-size-base opacity-50 mr-1"></i> Live Preview
            </a>
          </router-link>
        </div>
